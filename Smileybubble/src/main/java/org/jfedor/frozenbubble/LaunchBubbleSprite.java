...
public class LaunchBubbleSprite extends Sprite {
  ...
  private BmpWrap bubbleRainbow;
  private boolean isRainbow;

  public LaunchBubbleSprite(int initialColor, double initialDirection,
                            Drawable launcher,
                            BmpWrap[] bubbles, BmpWrap[] colorblindBubbles, BmpWrap bubbleRainbow) {
    ...
    this.bubbleRainbow     = bubbleRainbow;
  ...
  public final void paint(Canvas c, double scale, int dx, int dy) {
    if(isRainbow) drawImage(bubbleRainbow, 302, 390, c, scale, dx, dy);
